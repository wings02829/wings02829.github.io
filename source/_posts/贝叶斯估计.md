...
可以写出联合密度函数：
$$
h(X,\mu)=\frac{1}{(2\pi)^{\frac{n+1}{2}}{\sigma_0}^n\tau}\exp\left\{-\frac{1}{2{\sigma_0}^2}\sum_{i=1}^n(x_i-\mu)^2-\frac{1}{2\tau^2}(\mu-\theta)^2\right\}
$$
记 $k=\frac{1}{(2\pi)^{\frac{n+1}{2}}{\sigma_0}^n\tau}$， $A=\frac{n}{\sigma_0^2}+\frac{1}{\tau^2}$， $B=\frac{n\overline{x}}{\sigma_0^2}+\frac{\theta}{\tau^2}$， $C=\frac{\sum x_i^2}{\sigma_0^2}+\frac{\theta^2}{\tau^2}$，其中 $\overline{x}$ 则为样本均值，则有：
$$
\begin {aligned}
h(X,\mu)&=k\exp\left\{-\frac{1}{2}(A\mu^2-2B\mu+C)\right\}\\
&=k\exp\left\{-\frac{A}{2}\left(\mu-\frac{B}{A}\right)^2-\frac{1}{2}\left(C-\frac{B^2}{A}\right)\right\}
\end {aligned}
$$
从而 $X$ 的边缘密度 $m(X)=k\exp\{-\frac{1}{2}(C-\frac{B^2}{A})\}\sqrt{\frac{2\pi}{A}}$，然后知后验估计为：
$$
\pi(\mu|X)=\sqrt{\frac{A}{2\pi}}\exp\left\{-\frac{1}{2/\frac{1}{A}}\left(\mu-\frac{B}{A}\right)^2\right\}
$$
可以看出这是期望为 $\frac{B}{A}$，方差为 $\frac{1}{A}$ 的正态分布，其贝叶斯估计为：
$$
\hat{\mu_B}=\frac{B}{A}=\frac{n\tau^2\overline{x}+\sigma_0^2\theta}{n\tau^2+\sigma_0^2}=\frac{\frac{n}{\sigma_0^2}}{\frac{n}{\sigma_0^2}+\frac{1}{\tau^2}}\overline{x}+\frac{\frac{1}{\tau^2}}{\frac{n}{\sigma_0^2}+\frac{1}{\tau^2}}\theta
$$
{% endraw %}
